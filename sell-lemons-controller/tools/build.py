...
def main():
    ...
    compat=('-- Generated read-only game version compatibility audit. No game actions.\n'
        ...
        '\nend)()\nreturn inspect()\n')
    evolution_only=('-- Standalone evolution-only mode. No buys, upgrades, rebirths or Halo.\n'
        'local context={}\n'
        'local upgrade=(function()\n'+(ROOT/'src/core/UpgradeMath.luau').read_text(encoding='utf-8')+'\nend)()\n'
        'local prestige=(function()\n'+(ROOT/'src/core/PrestigeMath.luau').read_text(encoding='utf-8')+'\nend)()\n'
        'local start=(function()\n'+(ROOT/'src/modes/EvolutionOnly.luau').read_text(encoding='utf-8')+'\nend)()\n'
    ...
    if args.check:
        ...
        assert (ROOT/'dist/evolution-only.lua').read_text(encoding='utf-8')==evolution_only,'Evolution-only mode is stale'
        ...
        (ROOT/'dist/evolution-only.lua').write_text(evolution_only,encoding='utf-8',newline='\n')
